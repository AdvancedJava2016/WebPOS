	...
	<body>
		...
		<div class="ui container">
			<div class="ui middle aligned center aligned grid">
				...
				<a class="navie" href="#" id="loginbtn"> Log In </a>
			</div>	
		</div>
		...
		<div class="content">
   			<div class="ui stacked segment">
       			<div class="inline field">
					...
					<i class="user icon"></i>
						<input type="text" class="five wide field" name="username" placholder="username"/>
					</div>
				</div>
				<br/>
       			<div class="field">
       				<div class="ui left icon input">
					<i class="lock icon"></i>
						<input type="password"  class="five wide field" name="password" placholder="password"/>
					</div>
				</div>
			</div>
		</div>
		<div class="action">
			<button type="submit" class="ui fluid large black submit button" >Log In</button>
		</div>
		</form>
	</div>
	<div class="ui top aligned center aligned grid">
			<div class="column column2">
				<a class="hddst"> ANNOUNCEMENTS </a>
				<hr/>
				<div class="ancont">
					<a class="antitle">Announcement Title</a>
