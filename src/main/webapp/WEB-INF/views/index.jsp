		...
		<div class="content" >
   			<div class="ui stacked segment">
       			<div class="inline field">
					...
					<i class="user icon"></i>
						<input type="text" name="username" class="five wide field" placholder="username"/>
					</div>
				</div>
				<br/>
       			<div class="field">
       				<div class="ui left icon input">
					<i class="lock icon"></i>
						<input type="password"  name="password" class="five wide field" placholder="password"/>
					</div>
				</div>
			</div>
		</div>
		<div class="action">
			<button type="submit" class="ui fluid large yellow submit button" >Log In</button>
		</div>
		</form>
	</div>
